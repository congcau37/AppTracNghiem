...
/**
 * Created by trand on 3/20/2018.
 */

public class CheckAnswerAdapter extends BaseAdapter {
    private Context context;
    private int layout;
    private ArrayList<QuestionModel> lsData;

    public CheckAnswerAdapter(Context context, int layout, ArrayList<QuestionModel> lsData) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        int j = i+1;
        QuestionModel questionModel = lsData.get(i);
